...
export const offensiveTerms: GeneratedFlashcard[] = [
...
export const defensiveTerms: GeneratedFlashcard[] = [
  // Beginner
...
export const specialTeamsTerms: GeneratedFlashcard[] = [
  // Beginner
...
export const generalTerms: GeneratedFlashcard[] = [
  // Beginner
...
export const fantasyTerms: GeneratedFlashcard[] = [
  // Beginner
...
export const analyticsTerms: GeneratedFlashcard[] = [
  // Intermediate
...
export const strategyTerms: GeneratedFlashcard[] = [
  // Intermediate
...
export const positionTerms: GeneratedFlashcard[] = [
  // Beginner
...
export const allTerminology: GeneratedFlashcard[] = [
  ...offensiveTerms,
  ...defensiveTerms,
  ...specialTeamsTerms,
  ...generalTerms,
...
export const terminologyByDifficulty: {
  beginner: GeneratedFlashcard[];
  intermediate: GeneratedFlashcard[];
  advanced: GeneratedFlashcard[];
} = {
