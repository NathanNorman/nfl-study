...
export const quarterbackMCQs: GeneratedMCQ[] = [
...
export const runningBackMCQs: GeneratedMCQ[] = [
  // Saquon Barkley
  {
...
export const wideReceiverMCQs: GeneratedMCQ[] = [
...
export const tightEndMCQs: GeneratedMCQ[] = [
  // Sam LaPorta
  {
...
export const allPlayerMCQs: GeneratedMCQ[] = [
  ...quarterbackMCQs,
  ...runningBackMCQs,
  ...wideReceiverMCQs,
  ...tightEndMCQs
