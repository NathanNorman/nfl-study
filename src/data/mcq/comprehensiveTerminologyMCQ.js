 ...
 * Based on agent outputs for remaining terminology from nflTerminology.js
...
// Total: 94 questions to add to the 14 offensive terms already in terminologyMCQ.js

export const comprehensiveTerminologyMCQs = [
