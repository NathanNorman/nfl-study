...
import { generateFlashcardsByDifficulty } from '../generateByDifficulty.js';
import { generateMCQByDifficulty } from '../mcq/generateMCQByDifficulty.js';

/**
 * Check if card tags match any of the required tags
 */
function hasAnyTag(card, requiredTags) {
 ...
 */
function matchesDifficulty(card, difficulty) {
 ...
 */
export function generateFlashcardModuleMappings() {
 ...
 */
export function generateMCQModuleMappings() {
 ...
 */
export function getCardsForModule(moduleId, cardType = 'flashcard') {
 ...
 */
export function getModulesForCard(questionText, cardType = 'flashcard') {
  const mappings = cardType === 'flashcard'
    ? generateFlashcardModuleMappings()
    : generateMCQModuleMappings();

  const modulesContainingCard = [];
...
export function getModuleMappingStats() {
  ...
  Object.keys(flashcardMappings).forEach(moduleId => {
    const flashcardCount = flashcardMappings[moduleId].length;
    const mcqCount = mcqMappings[moduleId].length;
